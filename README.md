...
### Warning! Bot was ported to the vk-io module! Updates to the node-vk-bot-api module WILL NOT be released! Bot support on the node-vk-bot-api module will end on March 1, 2020
